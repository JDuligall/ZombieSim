...
public class LineIterator implements Iterator<Point2D> {
	final static double DEFAULT_PRECISION = 0.000001;
	//final static double DEFAULT_PRECISION = 0.000000000000001;
	final Line2D line;
	...
	public boolean hasNext() {
		return Math.abs( x - line.getX2()) > 0.000009 || ( Math.abs(y - line.getY2()) > 0.000009);
	}
